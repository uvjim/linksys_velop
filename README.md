...
| Mesh | Online Devices | ✔️ | Count of online devices | List of online device names, unique ID, IP, IPv6, connection type, parent name and if they're on the guest network | |
